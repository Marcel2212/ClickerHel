...
function markTextsWithinSpan() {
  const turquoiseTags = ["[YSL]", "[CP9]", "[Mad]", "[Nike]", "naka", "Cube", "[1v9]", "[NL]", "[NLC]", "[NRW]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]"]; //allies
  ...
  const redTags = ["[KOA]", "xxxxxxxxxxx", "[D3S]", "[sRev]", "[ly]", "[R8]", "[Do.it]", "[808]", "[K0A]", "Kuduro", "C.at", "Sarah.girl", "[HTP]", "[AR]", "[Nvm]", "[1994]", "[Cruel]", "[888]", "[Aura]", "[Q2]", "[99]", "[INRX]", "[CVS]", "[SXN]", "[6ang]", "[Way]", "[lKOAl]"
                  , "[Bay]", "LLC", "Ms.Pwo", "[Ditsy]", "Batzen", "[44]", "[ZX]", "[VS]", "[Love]", "Protech", "[OL]", "[19]", "[RoRo]", "Okane", "Esco", "[A.R]", "[[Volt]", "[C_F]", "Lilli", "Glassy", " DESTROYER", "GBDEATH", "Fufelshmerz"
                  , "[Athen]", "Shafz", "[Ditto]", "await", "Gazy", "kko", "Avensis", "Alucard", "[Q1]", "[Weep]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]", "[xxxxxxx]"
